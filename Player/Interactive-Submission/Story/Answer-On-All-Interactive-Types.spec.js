...
let browser;
let pages;
const testUnit = "https://galtubi91.github.io/articles/Story-stg/";
let apesterIframe;
...
test("Interactive Poll", async () => {
    ...
    expect(nextSlideTitle[1]).toBe("Quiz");
});
test("Interactive Quiz", async () => {
    ...
    expect(nextSlideTitle[1]).toBe("Interactive Image");
});

test("Interactive Image", async () => {
