...
let browser;
let pages;
const testUnit = 'https://renderer.apester.com/v2/5c51a3986ca9ad0ed248fadd?preview=true&iframe_preview=true';
let apesterIframe;
let UnitLength;
const playerEvents = [];
...
test('finish the unit', async () => {
    ...
    await apesterIframe.click('div[class^=StyledStoryCoverButton]');
